              ...
              <div className="space-y-2">
                ...
                <div className="space-y-1.5 text-xs">
                  <button
                    ...
                    className={`w-full p-2.5 rounded-xl border text-left transition-all ${!isGuest && currentCustomer === "cust-001"
                  ...
                  <button
                    ...
                    className={`w-full p-2.5 rounded-xl border text-left transition-all ${!isGuest && currentCustomer === "cust-002"
                        ? "bg-blue-600/20 border-blue-500 text-white font-semibold shadow-sm"
                        : "bg-slate-950 border-slate-800 text-slate-400 hover:bg-slate-800/40"
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`w-full p-2.5 rounded-xl border text-left transition-all ${isGuest
